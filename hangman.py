...
WOERTER =  ['PARIS', 'DUBLIN', 'ZAGREB', 'RIGA', 'VADUZ', 'VILNIUS', 'LUXEMBURG', 'VALLETTA', 'BERLIN', 'MONACO', 'AMSTERDAM', 'SKOPJE', 'OSLO', 'WIEN', 'WARSCHAU', 'LISSABON', 'BUKAREST', 'MOSKAU', 'STOCKHOLM', 'BELGRAD', 'BRATISLAVA', 'LJUBLJANA', 'MADRID', 'PRAG', 'ANKARA','DUESSELDORF', 'KOELN']
